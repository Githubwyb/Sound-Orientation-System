...
#define ENABLE_MK()     {CNENBbits.CNIEB14=1;CNENBbits.CNIEB1=1;CNENBbits.CNIEB3=1;INTClearFlag(INT_CNB);}
#define DISABLE_MK0()   {CNENBbits.CNIEB14=0;INTClearFlag(INT_CNB);}
